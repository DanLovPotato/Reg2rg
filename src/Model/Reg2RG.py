...
class Reg2RG(nn.Module):
    def __init__(self, text_tokenizer_path, lang_model_path, pretrained_visual_encoder,pretrained_finegrain_visual_encoder, pretrained_adapter,bank_npy_path, max_region_size=10, max_img_size = 1, image_num = 32):
        ...
        self.embedding_layer = MyEmbedding(pretrained_visual_encoder,pretrained_finegrain_visual_encoder, pretrained_adapter,bank_npy_path)
